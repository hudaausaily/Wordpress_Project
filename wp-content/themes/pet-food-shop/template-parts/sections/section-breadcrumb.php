<?php 
	$petfoodshop_hs_breadcrumb					= get_theme_mod('hs_breadcrumb','1');
	$petfoodshop_breadcrumb_bg_img				= get_theme_mod('breadcrumb_bg_img');
	$petfoodshop_breadcrumb_back_attach		= get_theme_mod('breadcrumb_back_attach','scroll');
	
if($petfoodshop_hs_breadcrumb == '1') {	
?>	

	<!-- Slider Area -->   
	<?php if(!empty($petfoodshop_breadcrumb_bg_img)): ?>
    <section class="slider-area breadcrumb-section" style="background: url(<?php echo esc_url($petfoodshop_breadcrumb_bg_img); ?>) center center <?php echo esc_attr($petfoodshop_breadcrumb_back_attach); ?>; background-repeat: no-repeat; background-size: cover;">
	<?php else: ?>
	 ...
	 <?php endif; ?>
        <div class="container">
            <div class="about-banner-text">   
				...
				<h1><?php petfoodshop_breadcrumb_title(); ?></h1>
				
				<ol class="breadcrumb-list">
					<?php petfoodshop_breadcrumbs(); ?>
				</ol>
