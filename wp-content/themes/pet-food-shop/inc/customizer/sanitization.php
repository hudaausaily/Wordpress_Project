 ...
 */
function petfoodshop_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function petfoodshop_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function petfoodshop_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function petfoodshop_sanitize_float( $input ) {
 ...
 */
function petfoodshop_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function petfoodshop_sanitize_html( $html ) {
 ...
 */
function petfoodshop_sanitize_image( $image, $setting ) {
 ...
 */
function petfoodshop_sanitize_nohtml( $nohtml ) {
 ...
 */
function petfoodshop_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function petfoodshop_sanitize_range_value( $number, $setting ) {
 ...
 */
function petfoodshop_sanitize_select( $input, $setting ) {
 ...
 */
function petfoodshop_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function petfoodshop_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function petfoodshop_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
